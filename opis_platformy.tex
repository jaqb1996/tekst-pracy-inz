...
%TODO2 W sumie zdjęcie ZYBO nie zaszkodzi, ale takie nie na pół storny, tylko skromniejsze (wykonane)
...
%TODO2 proszę doczytać, bo slave to są te General Purpose, a pozostałe są master. Tzn. nie musi Pan tego rozkmniać, ale trzeba dopisać, że master też. (wykonane)
...
%TODO2 Zdjęcie ? Ilustracja ? Może ew. obok tego Zybo, bo powinno się ładnie zmieścić. (wykonane razem z kartą)
...
%TODO2 Fotos ?(wykonane)
\label{sec:autopilot}
Urządzeniem bezpośrednio komunikującym się z~kontrolerami silników jest sterownik. 
W~pracy wykorzystano urządzenie Pixhawk -- popularny kontroler lotu ogólnego przeznaczenia, którego oprogramowanie jest dostępne na~otwartej licencji. %TODO2 a nie raczej jego obprogramowanie (wykonane) 
...
Umożliwia on~bowiem wysyłanie dronowi komend dotyczących zmiany szybkości i~ kierunku lotu. %TODO2 nieco niejasna konstrukcja może szybkości i kierunku lotu ? (wykonane)
