...
\begin{abstractpage}
	\begin{abstract}{polish}
		W projekcie zaprezentowano programowo-sprzętowy system wizyjny wspomagający autonomiczne lądowanie drona. System opiera się na przetwarzaniu sygnału z kamery oraz laserowego czujnika wysokości w celu wysyłania sygnałów sterujących do drona. Obliczenia podzielone zostały pomiędzy logikę reprogramowalną, a system procesorowy. Wykonane testy potwierdziły możliwość wykonania lądowania na statycznej platformie przy użyciu stworzonego systemu.
		\bigskip
...
\include{metody}
\include{opis_platformy}
\include{implementacja_modelu}
\include{implementacja_systemu}
