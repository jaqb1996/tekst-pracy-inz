...
\end{figure}
\subsection{Przestrzeń barw RGB}
\label{sec:RGB}
...
Zastosowanie binaryzacji ze stałym progiem (rysunek \ref{fig:bin}) pozwoliło na oddzielenie znacznika od tła. %TODO ze stałym progiem ?
